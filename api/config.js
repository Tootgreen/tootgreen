module.exports = function handler(req, res) {
  ...
  const config = {
    maintenance: { enabled: false, page: '/maintenance.html' },
    analytics: { gaId: null },
    business: {
      name: 'TootGreen',
    ...
    shops: { ebay: null, shopify: null, website: null },
    contact: { phone: null, responseTime: 'We aim to reply within 24 hours, Monday–Friday' },
    web3forms: {
      accessKey: process.env.WEB3FORMS_API || '',
    },
    social: {
      instagram: null,
      facebook: null,
