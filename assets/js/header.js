...
if (btns) {
  btns.innerHTML = `
    ...
    ${A.enabled && A.searchUrl && A.searchUrl !== 'xxxxx' ? `<a class="nav-amz-btn" href="${A.searchUrl}" rel="noopener noreferrer" target="_blank" title="Shop on Amazon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"><path fill="#ff9900" d="M13.958 10.09c0 1.232.029 2.256-.591 3.351-.502.891-1.301 1.438-2.186 1.438-1.214 0-1.922-.924-1.922-2.292 0-2.692 2.415-3.182 4.7-3.182v.685zm3.186 7.705a.66.66 0 01-.76.074c-1.067-.887-1.258-1.298-1.842-2.144-1.76 1.795-3.006 2.333-5.288 2.333-2.7 0-4.8-1.667-4.8-5.002 0-2.604 1.41-4.378 3.42-5.243 1.742-.77 4.174-.905 6.034-1.117v-.417c0-.769.06-1.677-.392-2.339-.392-.593-1.148-.838-1.815-.838-1.232 0-2.33.632-2.6 1.94-.055.291-.269.578-.563.593l-3.155-.34c-.266-.06-.561-.275-.484-.683C5.894 2.71 8.913 2 11.618 2c1.395 0 3.22.371 4.323 1.428C17.24 4.614 17.144 6.185 17.144 7.9v5.069c0 1.524.631 2.195 1.225 3.019.208.292.254.641-.014.858l-1.211 1.949zm2.533 1.84C17.7 21.142 14.96 22 12.557 22c-3.326 0-6.33-1.23-8.597-3.277-.178-.161-.019-.381.196-.256 2.448 1.422 5.471 2.279 8.6 2.279 2.108 0 4.426-.438 6.557-1.343.321-.137.592.21.364.432z"/></svg></a>` : A.enabled && A.searchUrl ? `<span class="amz-wrap"><a class="nav-amz-btn" style="opacity:0.6;pointer-events:none;cursor:default;" title="Coming Soon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"><path fill="#ff9900" d="M13.958 10.09c0 1.232.029 2.256-.591 3.351-.502.891-1.301 1.438-2.186 1.438-1.214 0-1.922-.924-1.922-2.292 0-2.692 2.415-3.182 4.7-3.182v.685zm3.186 7.705a.66.66 0 01-.76.074c-1.067-.887-1.258-1.298-1.842-2.144-1.76 1.795-3.006 2.333-5.288 2.333-2.7 0-4.8-1.667-4.8-5.002 0-2.604 1.41-4.378 3.42-5.243 1.742-.77 4.174-.905 6.034-1.117v-.417c0-.769.06-1.677-.392-2.339-.392-.593-1.148-.838-1.815-.838-1.232 0-2.33.632-2.6 1.94-.055.291-.269.578-.563.593l-3.155-.34c-.266-.06-.561-.275-.484-.683C5.894 2.71 8.913 2 11.618 2c1.395 0 3.22.371 4.323 1.428C17.24 4.614 17.144 6.185 17.144 7.9v5.069c0 1.524.631 2.195 1.225 3.019.208.292.254.641-.014.858l-1.211 1.949zm2.533 1.84C17.7 21.142 14.96 22 12.557 22c-3.326 0-6.33-1.23-8.597-3.277-.178-.161-.019-.381.196-.256 2.448 1.422 5.471 2.279 8.6 2.279 2.108 0 4.426-.438 6.557-1.343.321-.137.592.21.364.432z"/></svg></a><span class="amz-coming-banner" style="font-size:0.42rem;top:-4px;right:-4px;">Soon</span></span>` : ""}
}
